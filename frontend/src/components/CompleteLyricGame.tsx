...
function CompleteLyricGameComponent({ onBack }: { onBack: () => void }) {
    ...
    return (
        <PlayGameFrame
            title="Guess The Lyric"
            subtitle="Only the lyric is visible before you answer. Song and artist reveal after the lock-in."
            onBack={onBack}
            stats={[
            ...
            hero={current ? (
                <div className="lyric-hero lyric-hero--single-column">
                    <div className="lyric-hero-copy">
                        ...
                        <p>
                            {roundResult
                                ...
                                : 'No title, artist, or album metadata is shown before you answer.'}
                        </p>
        ...
        >
            {gameOver ? (
                ...
                <div className="lyric-game lyric-game--minimal">
                    <div className="lyric-prompt-stack">
                        <div className="lyric-prompt">{current.maskedPrompt}</div>
                        {!roundResult && <p className="lyric-prompt-note">Pick the missing phrase. The next round starts automatically after the reveal.</p>}
                    </div>
                    ...
                    {!roundResult ? (
                        ...
                        <div className={`arcade-result-card ${roundResult.correct ? 'is-correct' : 'is-wrong'}`}>
                            ...
                            {roundResult.correct ? <p className="points-earned">+{roundResult.points} XP</p> : <p className="album-name">Life lost. Combo reset.</p>}
                        </div>
                    )}
                </div>
            ) : null}
